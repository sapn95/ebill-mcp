...
// this check ever grew a tool call, it still could not reach the real portal
const child = spawn(process.execPath, [entry], {
  stdio: ['pipe', 'pipe', 'pipe'],
  env: { ...process.env, EBILL_BASE_URL: 'http://127.0.0.1:1', EBILL_CDP: 'http://127.0.0.1:1', EBILL_BANK_URL: '' },
});
let stderr = '';
